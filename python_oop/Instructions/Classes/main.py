...
# Calling a Method example
    def follow (self, user): # Creating a function to follow users. self is always included so the function knows the object that called it.
        user.followers += 1
        self.following += 1

user_1 = User("001", "Angela") # Created a user with default users from the Class above.
