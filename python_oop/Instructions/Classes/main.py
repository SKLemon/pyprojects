...
user_1 = User(
    "001", "Angela"
)  # Created a user with default users from the Class above, and automatically assigns attributes on creation (user_id, and username)
user_2 = User("002", "Dorothy")

user_1.follow(user_2)  # Performs the .follow()  method listed in the class above
...
# Constructors come into play. Shown on line 1.
